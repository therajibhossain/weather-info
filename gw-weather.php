...
function is_requirements_met()
{
    ...
    if (version_compare(PHP_VERSION, $min_php, '<')) {
        add_action('admin_notices', function () {
            conf::notice_div('error', 'GWDBBackup requires at least PHP 5.6. Please upgrade PHP. The Plugin has been deactivated.');
        });
        return false;
    }
    return true;
